...
public interface SpotifyService {
     ...
     */
    @GET("/user/{id}")
    Observable<User> getUserObs(@Path("id") String userId);
     ...
     */
    @GET("/users/{id}/playlists")
    Observable<Pager<PlaylistSimple>> getPlaylistsObs(@Path("id") String userId, @QueryMap Map<String, Object> options);
     ...
     */
    @GET("/users/{id}/playlists")
    Observable<Pager<PlaylistSimple>> getPlaylistsObs(@Path("id") String userId);
     ...
     */
    @GET("/users/{user_id}/playlists/{playlist_id}")
    Observable<Playlist> getPlaylistObs(@Path("user_id") String userId, @Path("playlist_id") String playlistId);
     ...
     */
    @GET("/users/{user_id}/playlists/{playlist_id}/tracks")
    Observable<Pager<PlaylistTrack>> getPlaylistTracksObs(@Path("user_id") String userId, @Path("playlist_id") String playlistId, @QueryMap Map<String, Object> options);
     ...
     */
    @GET("/users/{user_id}/playlists/{playlist_id}/tracks")
    Observable<Pager<PlaylistTrack>> getPlaylistTracksObs(@Path("user_id") String userId, @Path("playlist_id") String playlistId);
     ...
     */
    @POST("/users/{user_id}/playlists")
    Observable<Playlist> createPlaylistObs(@Path("user_id") String userId, @Body Map<String, Object> options);
     ...
     */
    @POST("/users/{user_id}/playlists/{playlist_id}/tracks")
    Observable<SnapshotId> addTracksToPlaylistObs(@Path("user_id") String userId, @Path("playlist_id") String playlistId, @QueryMap Map<String, Object> queryParameters, @Body Map<String, Object> body);
     ...
     */
    @DELETEWITHBODY("/users/{user_id}/playlists/{playlist_id}/tracks")
    Observable<SnapshotId> removeTracksFromPlaylistObs(@Path("user_id") String userId, @Path("playlist_id") String playlistId, @Body TracksToRemove tracksToRemove);
     ...
     */
    @DELETEWITHBODY("/users/{user_id}/playlists/{playlist_id}/tracks")
    Observable<SnapshotId> removeTracksFromPlaylistObs(@Path("user_id") String userId, @Path("playlist_id") String playlistId, @Body TracksToRemoveWithPosition tracksToRemoveWithPosition);
     ...
     */
    @PUT("/users/{user_id}/playlists/{playlist_id}/tracks")
    Observable<Result> replaceTracksInPlaylistObs(@Path("user_id") String userId, @Path("playlist_id") String playlistId, @Query("uris") String trackUris);
     ...
     */
    @PUT("/users/{user_id}/playlists/{playlist_id}")
    Observable<Result> changePlaylistDetailsObs(@Path("user_id") String userId, @Path("playlist_id") String playlistId, @Body Map<String, Object> body);
     ...
     */
    @PUT("/users/{user_id}/playlists/{playlist_id}/followers")
    Observable<Result> followPlaylistObs(@Path("user_id") String userId, @Path("playlist_id") String playlistId);
     ...
     */
    @PUT("/users/{user_id}/playlists/{playlist_id}/followers")
    Observable<Result> followPlaylistObs(@Path("user_id") String userId, @Path("playlist_id") String playlistId, @Body PlaylistFollowPrivacy playlistFollowPrivacy);
     ...
     */
    @DELETE("/users/{user_id}/playlists/{playlist_id}/followers")
    Observable<Result> unfollowPlaylistObs(@Path("user_id") String userId, @Path("playlist_id") String playlistId);
     ...
     */
    @PUT("/users/{user_id}/playlists/{playlist_id}/tracks")
    Observable<SnapshotId> reorderPlaylistTracksObs(@Path("user_id") String userId, @Path("playlist_id") String playlistId, @Body Map<String, Object> body);
     ...
     */
    @GET("/albums/{id}")
    Observable<Album> getAlbumObs(@Path("id") String albumId);
     ...
     */
    @GET("/albums/{id}")
    Observable<Album> getAlbumObs(@Path("id") String albumId, @QueryMap Map<String, Object> options);
     ...
     */
    @GET("/albums")
    Observable<Albums> getAlbumsObs(@Query("ids") String albumIds);
     ...
     */
    @GET("/albums")
    Observable<Albums> getAlbumsObs(@Query("ids") String albumIds, @QueryMap Map<String, Object> options);
     ...
     */
    @GET("/albums/{id}/tracks")
    Observable<Pager<Track>> getAlbumTracksObs(@Path("id") String albumId);
     ...
     */
    @GET("/albums/{id}/tracks")
    Observable<Pager<Track>> getAlbumTracksObs(@Path("id") String albumId, @QueryMap Map<String, Object> options);
     ...
     */
    @GET("/artists/{id}")
    Observable<Artist> getArtistObs(@Path("id") String artistId);
     ...
     */
    @GET("/artists")
    Observable<Artists> getArtistsObs(@Query("ids") String artistIds);
     ...
     */
    @GET("/artists/{id}/albums")
    Observable<Pager<Album>> getArtistAlbumsObs(@Path("id") String artistId);
     ...
     */
    @GET("/artists/{id}/albums")
    Observable<Pager<Album>> getArtistAlbumsObs(@Path("id") String artistId, @QueryMap Map<String, Object> options);
     ...
     */
    @GET("/artists/{id}/top-tracks")
    Observable<Tracks> getArtistTopTrackObs(@Path("id") String artistId, @QueryMap Map<String, Object> options);
     ...
     */
    @GET("/artists/{id}/top-tracks")
    Observable<Tracks> getArtistTopTrackObs(@Path("id") String artistId);
     ...
     */
    @GET("/artists/{id}/related-artists")
    Observable<Artists> getRelatedArtistsObs(@Path("id") String artistId);
     ...
     */
    @GET("/tracks/{id}")
    Observable<Track> getTrackObs(@Path("id") String trackId);
     ...
     */
    @GET("/tracks/{id}")
    Observable<Track> getTrackObs(@Path("id") String trackId, @QueryMap Map<String, Object> options);
     ...
     */
    @GET("/tracks")
    Observable<Tracks> getTracksObs(@Query("ids") String trackIds);
     ...
     */
    @GET("/tracks")
    Observable<Tracks> getTracksObs(@Query("ids") String trackIds, @QueryMap Map<String, Object> options);
     ...
     */
    @GET("/browse/featured-playlists")
    Observable<FeaturedPlaylists> getFeaturedPlaylistsObs();
     ...
     */
    @GET("/browse/featured-playlists")
    Observable<FeaturedPlaylists> getFeaturedPlaylistsObs(@QueryMap Map<String, Object> options);
     ...
     */
    @GET("/browse/new-releases")
    Observable<NewReleases> getNewReleasesObs();
     ...
     */
    @GET("/browse/new-releases")
    Observable<NewReleases> getNewReleasesObs(@QueryMap Map<String, Object> options);
     ...
     */
    @GET("/browse/categories")
    Observable<CategoriesPager> getCategoriesObs(@QueryMap Map<String, Object> options);
     ...
     */
    @GET("/browse/categories/{category_id}")
    Observable<Category> getCategoryObs(@Path("category_id") String categoryId, @QueryMap Map<String, Object> options);
     ...
     */
    @GET("/browse/categories/{category_id}/playlists")
    Observable<PlaylistsPager> getPlaylistsForCategoryObs(@Path("category_id") String categoryId, @QueryMap Map<String, Object> options);
     ...
     */
    @GET("/me/tracks")
    Observable<Pager<SavedTrack>> getMySavedTracksObs();
     ...
     */
    @GET("/me/tracks")
    Observable<Pager<SavedTrack>> getMySavedTracksObs(@QueryMap Map<String, Object> options);
     ...
     */
    @GET("/me/tracks/contains")
    Observable<Boolean[]> containsMySavedTracksObs(@Query("ids") String ids);
     ...
     */
    @PUT("/me/tracks")
    Observable<Result> addToMySavedTracksObs(@Query("ids") String ids);
     ...
     */
    @DELETE("/me/tracks")
    Observable<Result> removeFromMySavedTracksObs(@Query("ids") String ids);
     ...
     */
    @PUT("/me/following?type=user")
    Observable<Result> followUsersObs(@Query("ids") String ids);
     ...
     */
    @PUT("/me/following?type=artist")
    Observable<Result> followArtistsObs(@Query("ids") String ids);
     ...
     */
    @DELETE("/me/following?type=user")
    Observable<Result> unfollowUsersObs(@Query("ids") String ids);
     ...
     */
    @DELETE("/me/following?type=artist")
    Observable<Result> unfollowArtistsObs(@Query("ids") String ids);
     ...
     */
    @GET("/me/following/contains?type=user")
    Observable<Boolean[]> isFollowingUsersObs(@Query("ids") String ids);
     ...
     */
    @GET("/me/following/contains?type=artist")
    Observable<Boolean[]> isFollowingArtistsObs(@Query("ids") String ids);
     ...
     */
    @GET("/users/{user_id}/playlists/{playlist_id}/followers/contains")
    Observable<Boolean[]> areFollowingPlaylistObs(@Path("user_id") String userId,
                                   @Path("playlist_id") String playlistId,
                                   @Query("ids") String ids);
     ...
     */
    @GET("/search?type=track")
    Observable<TracksPager> searchTracksObs(@Query("q") String q);
     ...
     */
    @GET("/search?type=track")
    Observable<TracksPager> searchTracksObs(@Query("q") String q, @QueryMap Map<String, Object> options);
     ...
     */
    @GET("/search?type=artist")
    Observable<ArtistsPager> searchArtistsObs(@Query("q") String q);
     ...
     */
    @GET("/search?type=artist")
    Observable<ArtistsPager> searchArtistsObs(@Query("q") String q, @QueryMap Map<String, Object> options);
     ...
     */
    @GET("/search?type=album")
    Observable<AlbumsPager> searchAlbumsObs(@Query("q") String q);
     ...
     */
    @GET("/search?type=album")
    Observable<AlbumsPager> searchAlbumsObs(@Query("q") String q, @QueryMap Map<String, Object> options);
     ...
     */
    @GET("/search?type=playlist")
    Observable<PlaylistsPager> searchPlaylistsObs(@Query("q") String q);
     ...
     */
    @GET("/search?type=playlist")
    Observable<PlaylistsPager> searchPlaylistsObs(@Query("q") String q, @QueryMap Map<String, Object> options);
}
